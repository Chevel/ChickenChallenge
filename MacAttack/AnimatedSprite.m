...
+ (void) initialize {
	NSSortDescriptor *frameStartSortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"start" ascending:YES];
	
	frameStartSort = [NSArray arrayWithObject:frameStartSortDescriptor];
}
